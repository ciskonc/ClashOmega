...
[![Version](https://img.shields.io/badge/version-1.3.8-blue?style=flat-square)](https://github.com/ciskonc/ClashOmega)
...
- [mihomo](https://github.com/MetaCubeX/mihomo) — Clash.Meta 更名后的项目，Clash Verge Rev 默认使用的代理内核，本项目实际运行所依赖的内核
