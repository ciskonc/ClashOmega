...
- [ciskonc](https://github.com/ciskonc) & [MagicalYu](https://github.com/MagicalYuYu) — ciskonc 负责核心开发，MagicalYu 担任首席小白鼠兼 AI 编码调教师。开发期间，MagicalYu 以独到的"调教"技巧让 AI 高效产出可用的代码。没有他的阴阳怪气，就没有现在的 ClashOmega。
