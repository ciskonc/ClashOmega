...
- [Clash](https://github.com/Dreamacro/clash) — The proxy core managed by this project. Thanks to Dreamacro and community contributors for their open-source dedication
- [Clash Verge Rev](https://github.com/clash-verge-rev/clash-verge-rev) — Excellent Clash GUI client. This project is compatible with its API interface and config format
